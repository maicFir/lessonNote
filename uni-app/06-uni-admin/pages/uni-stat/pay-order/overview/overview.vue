	...
	<view class="fix-top-window">
		...
		<view class="uni-container">
			<view class="uni-stat--x flex p-1015">
				...
				<uni-data-select ref="version-select" collection="opendb-app-versions" :where="versionQuery" class="ml-m" field="_id as value, version as text" orderby="text asc" label="版本选择" v-model="query.version_id" />
			</view>
